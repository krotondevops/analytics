...
def section_header(title, desc="", unit=""):
    ...
    if desc or unit:
        ...
        if desc:
            parts.append(desc)
        if unit:
            parts.append(f'<span class="section-unit">{unit}</span>')
        html += f'<div class="section-desc">{" ".join(parts)}</div>'
    return html
...
def tab_dashboard_general(df):
    ...
    with col1:
        st.markdown(section_header("Atenciones por Mes", "Total de atenciones registradas en cada mes del periodo", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(section_header("Tendencia Semanal de Atenciones", "Evoluci\u00f3n semanal del volumen de atenciones con suavizado", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
        semana_data = df.copy()
    ...
    with col3:
        st.markdown(section_header("Remoto vs Presencial", "Comparaci\u00f3n entre atenciones remotas y presenciales", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col4:
        st.markdown(section_header("Distribuci\u00f3n por Motivo", "Cantidad de atenciones por cada tipo de motivo", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
...
def tab_analisis_tecnico(df):
    ...
    st.markdown(section_header("Mapa de Calor: Atenciones por D\u00eda y Hora", "Concentraci\u00f3n de atenciones seg\u00fan d\u00eda de la semana y hora del d\u00eda", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col1:
        st.markdown(section_header("Top 20 Modelos m\u00e1s Atendidos", "Modelos de equipo con mayor cantidad de atenciones registradas", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(section_header("Distribuci\u00f3n del Tiempo de Atenci\u00f3n", "Frecuencia de atenciones seg\u00fan su duraci\u00f3n en minutos", "Minutos"), unsafe_allow_html=True)
    ...
    # Motivo por marca
    st.markdown(section_header("Motivo de Atenci\u00f3n por Marca", "Composici\u00f3n de motivos para las 10 marcas m\u00e1s atendidas", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    st.markdown(section_header("Tasa de Garant\u00eda por Marca", "Porcentaje de atenciones por garant\u00eda en marcas con m\u00e1s de 10 casos", "Porcentaje (%)"), unsafe_allow_html=True)
    ...
    st.markdown(section_header("Top 10 Modelos con Mayor Tiempo Acumulado", "Modelos que han consumido m\u00e1s horas-t\u00e9cnico en total", "Minutos / Horas"), unsafe_allow_html=True)
...
def tab_analisis_ejecutivo(df):
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.markdown(section_header("Rendimiento por Vendedor", "Atenciones t\u00e9cnicas generadas por cada vendedor comercial", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(section_header("Top 15 Clientes por Atenciones", "Clientes con mayor volumen de solicitudes de soporte t\u00e9cnico", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    col3, col4 = st.columns(2)
    with col3:
        st.markdown(section_header("Distribuci\u00f3n por Canal", "Volumen de atenciones seg\u00fan el canal comercial", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col4:
        st.markdown(section_header("Evoluci\u00f3n Mensual por Motivo", "Comparaci\u00f3n mensual del volumen por cada tipo de motivo", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    # Treemap
    st.markdown(section_header("Mapa de Clientes por Canal", "Distribuci\u00f3n jer\u00e1rquica de clientes agrupados por canal comercial", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
...
def tab_productividad(df):
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.markdown(section_header("Atenciones por T\u00e9cnico por Mes", "Volumen mensual de atenciones por cada t\u00e9cnico", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(section_header("Distribuci\u00f3n de Tiempo por T\u00e9cnico", "Rango y dispersi\u00f3n del tiempo de atenci\u00f3n por t\u00e9cnico", "Minutos"), unsafe_allow_html=True)
    ...
    # Radar chart
    st.markdown(section_header("Perfil Comparativo de T\u00e9cnicos", "Comparaci\u00f3n multidimensional del desempe\u00f1o de cada t\u00e9cnico", "Escala relativa (0-100)"), unsafe_allow_html=True)
    radar_data = []
...
def tab_marcas_productos(df):
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.markdown(section_header("Participaci\u00f3n por Marca", "Volumen y porcentaje de atenciones por cada marca", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(section_header("Top 15 Productos m\u00e1s Atendidos", "Modelos con mayor cantidad de solicitudes de soporte", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    st.markdown(section_header("Marca vs Motivo de Atenci\u00f3n", "Mapa de calor: intensidad de cada motivo por marca", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    # Sunburst
    st.markdown(section_header("Jerarqu\u00eda: Marca / L\u00ednea / Modelo", "Exploraci\u00f3n interactiva de la estructura del portafolio de productos", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    st.markdown('<div class="custom-divider"></div>', unsafe_allow_html=True)
    st.markdown(section_header("Productos con Mayor Incidencia de Garant\u00eda", "Modelos con m\u00e1s casos de garant\u00eda registrados", "Casos de garant\u00eda"), unsafe_allow_html=True)
...
def tab_clientes(df):
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.markdown(section_header("Top 20 Clientes por Atenciones", "Clientes con mayor volumen de solicitudes de soporte", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(section_header("Atenciones por Canal", "Total de atenciones por cada canal comercial", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
        ...
        st.markdown(section_header("Clientes \u00danicos por Canal", "Cantidad de clientes distintos atendidos en cada canal", "N.\u00b0 de clientes"), unsafe_allow_html=True)
    ...
    # Scatter
    st.markdown(section_header("Segmentaci\u00f3n: Atenciones vs Tiempo Promedio", "Relaci\u00f3n entre frecuencia y complejidad de atenci\u00f3n por cliente", "N.\u00b0 de atenciones vs Minutos"), unsafe_allow_html=True)
    ...
    st.markdown('<div class="custom-divider"></div>', unsafe_allow_html=True)
    st.markdown(section_header("Clientes con Mayor Tasa de Garant\u00eda", "Clientes con mayor proporci\u00f3n de atenciones por garant\u00eda", "Porcentaje (%)"), unsafe_allow_html=True)
    if len(df_clientes) > 0:
...
def tab_indicadores_kpi(df):
    ...
    st.markdown(section_header("Cumplimiento de SLA", "Porcentaje de atenciones resueltas dentro de los umbrales de tiempo", "Porcentaje (%)"), unsafe_allow_html=True)
    ...
    # Capacidad diaria
    st.markdown(section_header("Utilizaci\u00f3n de Capacidad Diaria", "Volumen diario de atenciones comparado con el promedio del periodo", "N.\u00b0 de atenciones"), unsafe_allow_html=True)
    ...
    # Crecimiento mensual
    st.markdown(section_header("Crecimiento Mensual", "Variaci\u00f3n porcentual del volumen de atenciones entre meses", "N.\u00b0 de atenciones y Variaci\u00f3n (%)"), unsafe_allow_html=True)
    ...
    # Indice de equidad
    st.markdown(section_header("\u00cdndice de Equidad en Distribuci\u00f3n de Carga", "Balance en la distribuci\u00f3n de carga de trabajo entre t\u00e9cnicos (100% = equitativa)", "Porcentaje (%)"), unsafe_allow_html=True)
